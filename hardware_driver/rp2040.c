...
#define SPI_1_PIN_MISO      ( GPIO_04 )
#define SPI_1_PIN_CS        ( GPIO_05 )
#define SPI_1_PIN_SCLK      ( GPIO_06 )
#define SPI_1_PIN_MOSI      ( GPIO_07 )
#define CAN_CTRL_PIN_IRQ    ( GPIO_21 )
#define LED_1_PIN           ( GPIO_25 )
...
VOID rp2040_init_spi_1_hw( VOID )
{
    ...
    gpio_set_function( SPI_1_PIN_MISO, GPIO_FUNC_SPI );
    gpio_set_function( SPI_1_PIN_MOSI, GPIO_FUNC_SPI );
    gpio_set_function( SPI_1_PIN_SCLK, GPIO_FUNC_SPI );

    gpio_init( SPI_1_PIN_CS );
    gpio_set_dir( SPI_1_PIN_CS, GPIO_OUT );
}
