...
// #define OPMODE_NORMAL       ( (UINT8)0U )
// #define OPMODE_SLEEP        ( (UINT8)1U )
// #define OPMODE_LOOPBACK     ( (UINT8)2U )
// #define OPMODE_LISTENONLY   ( (UINT8)3U )
// #define OPMODE_CONFIG       ( (UINT8)4U )
// #define OPMODE_MINOF_IDX    ( OPMODE_NORMAL )
// #define OPMODE_MAXOF_IDX    ( OPMODE_CONFIG )
// #define OPMODE_NUMOF_ITEMS  ( (UINT8)( OPMODE_MAXOF_IDX + (UINT8)1U ) )
...
// }
// #endif /* DEBUG */
// RESULT_T set_opmode( UINT8 mode )
// {
//     const uint8_t next = OPMODE_TBL[ mode ];
//     const uint8_t current = get_opmode();
...
//     write_spi_0( SPICMD_WRITE_REG );
//     write_spi_0( REG_CNF3 );
//     write_spi_0_array( sizeof( baudrate ), baudrate );
